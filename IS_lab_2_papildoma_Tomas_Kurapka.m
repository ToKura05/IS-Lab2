...
y = (1 + 0.6 * sin (2 * pi * x1 / 0.7)) + 0.3 * sin (2 * pi * x1) / 2;
...
w11_1 = randn(1); w12_1 = randn(1);
w21_1 = randn(1); w22_1 = randn(1);
w31_1 = randn(1); w32_1 = randn(1);
w41_1 = randn(1); w42_1 = randn(1);
% neuronų bazės
b1_1 = randn(1);
b2_1 = randn(1);
b3_1 = randn(1);
...
for i = 1:40000
    ...
    for n = 1:length(x1)
        ...
        v1_1 = x1(n) * w11_1 + x2(n) * w12_1 + b1_1;
        v2_1 = x1(n) * w21_1 + x2(n) * w22_1 + b2_1;
        v3_1 = x1(n) * w31_1 + x2(n) * w32_1 + b3_1;
        v4_1 = x1(n) * w41_1 + x2(n) * w42_1 + b4_1;
        ...
        w11_1 = w11_1 + eta * delta1_1*x1(n);
        w21_1 = w21_1 + eta * delta2_1*x1(n);
        w31_1 = w31_1 + eta * delta3_1*x1(n);
        w41_1 = w41_1 + eta * delta4_1*x1(n);

        w12_1 = w12_1 + eta * delta1_1*x2(n);
        w22_1 = w22_1 + eta * delta2_1*x2(n);
        w32_1 = w32_1 + eta * delta3_1*x2(n);
        w42_1 = w42_1 + eta * delta4_1*x2(n);
...
% Laikome, kad po 40 tūkstančių iteracijų perėjus per visa įėjimo reikšmių
